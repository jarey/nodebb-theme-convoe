<ol class="breadcrumb">
	...
	<li itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">
		<a href="{relative_path}/reset" itemprop="url"><span itemprop="title">Reset Password</span></a>
	</li>
...
<div class="well">
	<div class="alert alert-success" id="success" style="display:none">
		...
		<p>Password successfully reset, please <a href="{relative_path}/login">log in again</a>.</p>
	</div>
	...
	<div class="alert alert-danger" id="error" style="display:none">
		...
		<p>The reset code received was incorrect. Please try again, or <a href="{relative_path}/reset">request a new reset code</a></p>
	</div>
	<form onsubmit="return false;" id="reset-form">
		...
		<button class="btn btn-primary btn-lg btn-block" id="reset" type="submit">Reset Password</button>
	</form>
</div>
